...
def main():
    ...
    class StartPage(Frame):
        def __init__(self, parent, controller):
            ...
            button = Button(right_frame, text="START", font=("Calibri", 12),
    ...
    class GamePage(Frame):
        def __init__(self, parent, controller):
            ...
            self.name_label_p0 = Label(self.frame_p0, font=("Calibri", 10), bd=3)
            self.name_label_p0.place(relx=0, rely=0, relheight=(1 / 3), relwidth=0.38)
            self.chips_label_p0 = Label(self.frame_p0, font=("Calibri", 10), bd=3)
            ...
            self.name_label_p1 = Label(self.frame_p1, font=("Calibri", 10), bd=3)
            self.name_label_p1.place(relx=0, rely=0, relheight=(1 / 3), relwidth=0.38)
            self.chips_label_p1 = Label(self.frame_p1, font=("Calibri", 10), bd=3)
            ...
            self.name_label_p2 = Label(self.frame_p2, font=("Calibri", 10), bd=3)
            self.name_label_p2.place(relx=0, rely=0, relheight=(1 / 3), relwidth=0.38)
            self.chips_label_p2 = Label(self.frame_p2, font=("Calibri", 10), bd=3)
            ...
            self.name_label_p3 = Label(self.frame_p3, font=("Calibri", 10), bd=3)
            self.name_label_p3.place(relx=0, rely=0, relheight=(1 / 3), relwidth=0.38)
            self.chips_label_p3 = Label(self.frame_p3, font=("Calibri", 10), bd=3)
            ...
            self.name_label_p4 = Label(self.frame_p4, font=("Calibri", 10), bd=3)
            self.name_label_p4.place(relx=0, rely=0, relheight=(1 / 3), relwidth=0.38)
            self.chips_label_p4 = Label(self.frame_p4, font=("Calibri", 10), bd=3)
            ...
            self.name_label_p5 = Label(self.frame_p5, font=("Calibri", 10), bd=3)
            self.name_label_p5.place(relx=0, rely=0, relheight=(1 / 3), relwidth=0.38)
            self.chips_label_p5 = Label(self.frame_p5, font=("Calibri", 10), bd=3)
            ...
            self.name_label_p6 = Label(self.frame_p6, font=("Calibri", 10), bd=3)
            self.name_label_p6.place(relx=0, rely=0, relheight=(1 / 3), relwidth=0.38)
            self.chips_label_p6 = Label(self.frame_p6, font=("Calibri", 10), bd=3)
            ...
            self.name_label_p7 = Label(self.frame_p7, font=("Calibri", 10), bd=3)
            self.name_label_p7.place(relx=0, rely=0, relheight=(1 / 3), relwidth=0.38)
            self.chips_label_p7 = Label(self.frame_p7, font=("Calibri", 10), bd=3)
            ...
            self.name_label_p8 = Label(self.frame_p8, font=("Calibri", 10), bd=3)
            self.name_label_p8.place(relx=0, rely=0, relheight=(1 / 3), relwidth=0.38)
            self.chips_label_p8 = Label(self.frame_p8, font=("Calibri", 10), bd=3)
            ...
            self.name_label_p9 = Label(self.frame_p9, font=("Calibri", 10), bd=3)
            self.name_label_p9.place(relx=0, rely=0, relheight=(1 / 3), relwidth=0.38)
            self.chips_label_p9 = Label(self.frame_p9, font=("Calibri", 10), bd=3)
            ...
            self.cc_1 = Label(self.cc_frame, bg="red")
            ...
            self.cc_2 = Label(self.cc_frame, bg="red")
            ...
            self.cc_3 = Label(self.cc_frame, bg="red")
            ...
            self.cc_4 = Label(self.cc_frame, bg="red")
            ...
            self.cc_5 = Label(self.cc_frame, bg="red")
            ...
            self.pot_label = Label(right_frame, text="pot: ", font=("Calibri", 12), bd=3)
            self.pot_label.place(relx=0, rely=0.2, relwidth=0.5, relheight=0.04)

            # self.dealer_label = Label(right_frame, text="dealer: ", font=("Calibri", 12), bd=3)
            # self.dealer_label.place(relx=0, rely=0.28, relwidth=0.5, relheight=0.04)

            # self.sb_label = Label(right_frame, text="small-blind: ", font=("Calibri", 12), bd=3)
            # self.sb_label.place(relx=0, rely=0.33, relwidth=0.5, relheight=0.04)

            # self.bb_label = Label(right_frame, text="big-blind: ", font=("Calibri", 12), bd=3)
            # self.bb_label.place(relx=0, rely=0.38, relwidth=0.5, relheight=0.04)

            self.action_frame = Frame(right_frame, bd=2, relief="raised")
            self.action_frame.place(rely=0.5, relwidth=1, relheight=0.5)
            self.action_cover_label = Label(self.action_frame, bg="red")
            self.action_cover_label.place(relx=0, rely=0, relheight=1, relwidth=1)

            self.actor_label = Label(self.action_frame, text="Actor: ", font=("Calibri", 12), bd=3)
            self.actor_label.place(relwidth=1, relheight=0.06)

            self.new_round_label = Label(self.action_frame, text="New Round?", font=("Calibri", 9), bd=3)
            ...
            self.raise_entry = Entry(self.action_frame, font=("Calibri", 9), bd=3)
            self.raise_entry.place(relx=0, rely=1, relheight=0.12, relwidth=0.22, anchor="sw")
            self.raise_button = Button(self.action_frame, text="RAISE", font=("Calibri", 9), bd=3, command=lambda: self.action_input(self.raise_entry.get()))
            self.raise_button.place(relx=0.22, rely=1, relheight=0.12, relwidth=0.22, anchor="sw")

            self.winner_label = Label(self.action_frame, font=("Calibri", 12), bd=3)
        ...
        def update(self, game):
            ...
            try:
                ...
                pass
            try:
                if game.list_of_players[0] == game.acting_player:
                    card1 = ImageTk.PhotoImage(
                ...
                if game.list_of_players[1] == game.acting_player:
                    card1 = ImageTk.PhotoImage(
                ...
                if game.list_of_players[2] == game.acting_player:
                    card1 = ImageTk.PhotoImage(
                ...
                if game.list_of_players[3] == game.acting_player:
                    card1 = ImageTk.PhotoImage(
                ...
                if game.list_of_players[4] == game.acting_player:
                    card1 = ImageTk.PhotoImage(
                ...
                if game.list_of_players[5] == game.acting_player:
                    card1 = ImageTk.PhotoImage(
                ...
                if game.list_of_players[6] == game.acting_player:
                    card1 = ImageTk.PhotoImage(
                ...
                if game.list_of_players[7] == game.acting_player:
                    card1 = ImageTk.PhotoImage(
                ...
                if game.list_of_players[8] == game.acting_player:
                    card1 = ImageTk.PhotoImage(
                ...
                if game.list_of_players[9] == game.acting_player:
                    card1 = ImageTk.PhotoImage(
            ...
            try:
                if game.list_of_players[0] == game.acting_player:
                    ...
                    card2 = ImageTk.PhotoImage(Image.open(str("cards\default0.png")).resize((55, 85), Image.ANTIALIAS))
            ...
            button_go = Button(self.action_frame, text="GO", font=("Calibri", 10), command=lambda: self.action_input(variable.get()))
